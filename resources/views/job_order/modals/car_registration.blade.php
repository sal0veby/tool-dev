        ...
        $('document').ready(function () {
            $(".btn-add-car_registration").click(function (e) {
                ...
                var str = '<div class="form-group row">'
                    ...
                    + '<div class="col-10"><input type="text" class="form-control m-input car_registration_name" name="car_registrations[' + count + '][name]" placeholder="{{ trans('main.car_registration') }}"></div>'
