...
(function ($) {
    ...
    $.fn.mDatatable = function (options) {
        if ($(this).length === 0)
            return;
        if ($(this).hasClass('m-datatable--loaded'))
            return;
        if ($(this).attr('id') === '')
        ...
        var dt = {
            ...
            afterRender: function (e, args) {
                if (args.table === $(datatable.table).attr('id')) {
                    ...
                    $(datatable).ready(function () {
                        ...
                        if (debug_error.length > 0) {// Modify By Joke : Check have ERROR after response API and after load data in Datatable  // 16/2/2018
                            error_row_detail(debug_error); // This variable is in  views->joblist.php  
                        }
                    });
                }
            },
            ...
            initHeight: function () {
                if (options.layout.height && options.layout.scroll) {
                    ...
                    if (typeof theadHeight !== 'undefined')
                        bodyHeight -= theadHeight;
                    if (typeof tfootHeight !== 'undefined')
            ...
            setupBaseDOM: function () {
                ...
                if (options.layout.height)
                    $(datatable).height(options.layout.height);
                ...
                if (options.layout.height)
                    $(datatable.table).height(options.layout.height);
                    ...
                    $(tr).find('.m-datatable__cell').each(function (tdi, td) {
                        ...
                        if (typeof column !== 'undefined') {
                            ...
                            if (typeof column.selector !== 'undefined' && column.selector !== false) {
                                ...
                                if ($(td).find('.m-checkbox [type="checkbox"]').length > 0)
                                    return;
                            ...
                            if (typeof column.subtable !== 'undefined' && column.subtable) {
                                ...
                                if ($(td).find('.m-datatable__toggle-subtable').length > 0)
                                    return;
            ...
            getData: function () {
                ...
                if (options.data.type === 'remote') {
                    ...
                    if (typeof params.url !== 'string')
                        params.url = API.getOption('data.source.read');
                    if (typeof params.url !== 'string')
            ...
            paging: function (meta, callback) {
                var pg = {
                    ...
                    init: function (meta) {
                        ...
                        if ($(pg.pager).hasClass('m-datatable--paging-loaded'))
                            return;
                    ...
                    gotoPage: function (e) {
                        ...
                        if ($(this).hasClass('m-datatable__pager-link--active'))
                            return;
            ...
            setupSubDatatable: function () {
                ...
                if (typeof detailCallback === 'function') {
                    ...
                    if ($(datatable.table).find('.m-datatable__detail').length > 0)
                        return;
